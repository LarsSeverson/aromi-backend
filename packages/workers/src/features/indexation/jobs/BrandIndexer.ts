import { unwrapOrThrow, type BrandIndex, type BrandRow, type INDEXATION_JOB_NAMES, type IndexationJobPayload } from '@aromi/shared'
...
export class BrandIndexer extends BaseIndexer<IndexationJobPayload[JobKey], BrandRow> {
  async index (job: Job<IndexationJobPayload[JobKey]>): Promise<BrandIndex> {
