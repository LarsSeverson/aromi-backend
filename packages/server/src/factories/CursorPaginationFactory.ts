...
export const PAGINATION_DIRECTIONS: Record<SortDirection, db.PaginationDirection> = {
  [SortDirection.Ascending]: 'asc',
  [SortDirection.Descending]: 'desc'
}

export const PAGINATION_OPERATORS: Record<SortDirection, db.PaginationOperator> = {
...
export abstract class CursorPaginationFactory<S, C> {
  ...
  parse (raw?: RawCursorPaginationArgs<S> | null): db.CursorPaginationInput<C> {
    const {
      first,
      after,
      sort: {
