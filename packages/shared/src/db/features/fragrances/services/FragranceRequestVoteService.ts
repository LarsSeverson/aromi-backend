...
import { type FragranceRequestRowWithVotes, type FragranceRequestVoteRow, type VoteInfoRow, type DB, TableService } from '@src/db/index.js'
...
export class FragranceRequestVoteService extends TableService<FragranceRequestVoteRow> {
  ...
  ): ResultAsync<FragranceRequestRowWithVotes[], BackendError> {
    let query = this
      .Table
      .connection
