...
import type { FragranceRequestImageRow, FragranceRequestRow, IFragranceRequestSummary } from '@src/features/fragranceRequests/types'
...
import { type CombinedTraitRow } from '@src/features/traits/types'
